...
{
  public class SavedLocalStar : SavedPlayerNameableCelestialObject
  {
    ...
    public override void ExposeData()
    {
      ...
      Scribe_Values.Look(ref systemIndex, "systemIndex");
      ...
      Scribe_Values.Look(ref rotationsPerDay, "rotationsPerDay");
